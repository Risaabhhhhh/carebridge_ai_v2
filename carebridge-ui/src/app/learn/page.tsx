  ...
  return (
    <>
      <style>{`
        ...
        :root{--ink:#0a0f0d;--ink2:#1a2018;--cream:#f0ece3;--paper:#e8e3d8;--sage:#1e5c2e;--sage2:#2d7a42;--mist:#5a7060;--border:#c8c2b4;}
        *{box-sizing:border-box;}
        ...
        /* HEADER */
        .page-hdr{max-width:1200px;margin:0 auto;padding:52px 64px 44px;display:flex;justify-content:space-between;align-items:flex-end;border-bottom:2px solid var(--border);}
        ...
        .page-sub{font-size:14px;font-weight:400;color:var(--ink2);max-width:380px;line-height:1.8;text-align:right;}

        /* CONTROLS */
        .controls{max-width:1200px;margin:0 auto;padding:36px 64px 0;display:flex;justify-content:space-between;align-items:flex-start;gap:24px;flex-wrap:wrap;}
        .controls-left{display:flex;flex-direction:column;gap:14px;}

        .cat-tabs{display:flex;gap:2px;flex-wrap:wrap;}
        .cat-tab{font-family:'DM Mono',monospace;font-size:10px;font-weight:500;letter-spacing:.12em;text-transform:uppercase;padding:9px 18px;background:white;border:1px solid var(--border);border-radius:2px;cursor:pointer;color:var(--mist);transition:all .15s;}
        .cat-tab:hover{color:var(--sage);border-color:var(--sage);}
        .cat-tab.active{background:var(--sage);color:white;border-color:var(--sage);}

        .count-label{font-family:'DM Mono',monospace;font-size:10px;font-weight:400;letter-spacing:.1em;color:var(--mist);}

        .search-wrap{position:relative;}
        .search-input{padding:11px 18px;border:1px solid var(--border);border-radius:2px;font-family:'DM Mono',monospace;font-size:11px;font-weight:400;color:var(--ink);background:white;outline:none;width:280px;transition:border-color .2s;}
        .search-input:focus{border-color:var(--sage);}
        .search-input::placeholder{color:#9a9890;}

        /* GRID */
        .grid{max-width:1200px;margin:32px auto 0;padding:0 64px;display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:var(--border);border:1px solid var(--border);border-radius:4px;overflow:hidden;}

        .resource-card{background:white;padding:28px;display:flex;flex-direction:column;gap:13px;transition:background .15s;text-decoration:none;color:inherit;}
        .resource-card:hover{background:#f5f0e8;}

        .card-top{display:flex;justify-content:space-between;align-items:flex-start;gap:8px;}
        .type-badge{font-family:'DM Mono',monospace;font-size:9px;font-weight:500;letter-spacing:.1em;text-transform:uppercase;padding:4px 10px;border-radius:2px;flex-shrink:0;}
        .source-label{font-family:'DM Mono',monospace;font-size:10px;font-weight:400;letter-spacing:.06em;color:var(--mist);}

        .card-title{font-family:'Cormorant Garamond',serif;font-size:19px;font-weight:500;line-height:1.3;color:var(--ink);}
        .card-desc{font-size:13px;font-weight:400;line-height:1.75;color:var(--ink2);flex:1;}

        .card-tags{display:flex;flex-wrap:wrap;gap:4px;}
        .card-tag{font-family:'DM Mono',monospace;font-size:9px;font-weight:400;letter-spacing:.06em;padding:3px 8px;background:var(--paper);color:var(--mist);border-radius:2px;}

        .card-footer{display:flex;justify-content:space-between;align-items:center;margin-top:4px;padding-top:13px;border-top:1px solid #eee8e0;}
        .card-link-label{font-family:'DM Mono',monospace;font-size:10px;font-weight:500;letter-spacing:.1em;text-transform:uppercase;color:var(--sage);}
        .card-arrow{color:var(--sage);font-size:14px;transition:transform .2s;}
        .resource-card:hover .card-arrow{transform:translate(2px,-2px);}

        .empty{max-width:1200px;margin:72px auto;padding:0 64px;text-align:center;font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:400;font-style:italic;color:var(--mist);}

        /* DISCLAIMER */
        .disclaimer{max-width:1200px;margin:40px auto 0;padding:0 64px 40px;display:flex;gap:12px;align-items:flex-start;background:var(--paper);border-top:1px solid var(--border);}
        .disclaimer{padding-top:24px;padding-bottom:24px;}
        .disc-icon{font-size:14px;color:var(--mist);flex-shrink:0;margin-top:2px;}
        .disc-text{font-family:'DM Mono',monospace;font-size:11px;font-weight:400;letter-spacing:.04em;color:var(--mist);line-height:1.7;}
        ...
        <div className="page-hdr">
          <div>
            ...
            <h1 className="page-title">
              Learn insurance.<br/><em>From official sources.</em>
            </h1>
          </div>
              ...
              return (
                <a key={i} href={r.url} target="_blank" rel="noopener noreferrer" className="resource-card">
                  <div className="card-top">
                    <span className="type-badge" style={{background:tc.bg,color:tc.color,border:`1px solid ${tc.border}`}}>{r.type}</span>
