...
export default function PrePurchasePage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (data) { setReport(data); setTimeout(() => window.scrollTo({ top:680, behavior:"smooth" }), 120); }
    } catch {
        ...
        <div className="input-section">
          ...
          <div className="sidebar">
            ...
            <div className="tips-card">
              ...
              {["Include the full policy schedule and benefit table","Paste exclusions and waiting period sections","Add co-payment and room rent clauses if available"].map((t,i) => (
        ...
        {report && (
          <>
              ...
              <div className="results-main">
                ...
                <div className="rcard">
                  <div className="rcard-hdr">
                    <span className="rcard-title">Policy Score</span>
                      ...
                      {Object.entries(report.irdai_compliance.compliance_flags)
                        ...
                        .map(([k, v]) => (
                          <div key={k} className="compliance-row">
                            ...
                            <span className="compliance-val" style={{color: v ? "#1e5c2e" : "#8c1f14"}}>
                              {v ? "✓" : "✗"}
                            </span>
                          </div>
                        ))}
            ...
            <p className="report-fn">
              CareBridge provides interpretative analysis only · Not legal advice or insurance endorsement · Verify all findings with your insurer or a qualified advisor
            </p>
          </>
        )}
      </div>
