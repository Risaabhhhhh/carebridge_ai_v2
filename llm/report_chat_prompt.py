...
# The lang param injects a language instruction at the end of the system block,
# telling MedGemma to respond in the target language.
...
def report_chat_prompt(
    ...
    """
    Build the full prompt for report-based Q&A.

    Parameters
    ----------
    report_data    : The full pre-purchase or audit report dict
    history        : List of {"role": "user"|"assistant", "content": str} dicts
    user_question  : Current user question
    lang           : BCP-47 language code — "en", "hi", "mr", "ta"
    """
...
REGULATORY CONSIDERATIONS: {report_data.get('regulatory_considerations', 'N/A')}"""
    ...
    return f"""You are CareBridge AI — an Indian health insurance expert.
